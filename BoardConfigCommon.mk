...
# Partitions
ifneq ($(WITH_GMS),true)
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 1425755136
endif
...
BOARD_MOTO_DYNAMIC_PARTITIONS_PARTITION_LIST := system product vendor
BOARD_MOTO_DYNAMIC_PARTITIONS_SIZE ?= 5363990528 # (BOARD_SUPER_PARTITION_SIZE / 2) - 4MB
